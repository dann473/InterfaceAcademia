...
public class ModalRenovarPlano extends JDialog {
    ...
    public ModalRenovarPlano(JFrame parent, String nomeAluno) {
        ...
        painelEsquerda.add(criarBotaoOpcao("Opção de pagamento 1"));
        painelEsquerda.add(Box.createVerticalStrut(15));
        painelEsquerda.add(criarBotaoOpcao("Opção de pagamento 2"));
        ...
        String[] parcelas = {"2 Vezes", "4 Vezes", "6 Vezes", "Ã€ vista"};
        ...
        // RodapÃ©
        JButton btnFinalizar = new JButton("Finalizar renovação");
